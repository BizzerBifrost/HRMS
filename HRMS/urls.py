...
urlpatterns = [
    ...
    path('staff/submit-feedback/', views.staff_submit_feedback, name='staff_submit_feedback'),
    ...
    path('hr/update-staff/<str:staff_id>/', views.update_staff, name='update_staff'),
    ...
    path('hr/feedback/search/', views.hr_feedback_search, name='hr_feedback_search'),  # <- ADD THIS LINE
    ...
    path('administrator/edit-user/<str:user_type>/<str:user_id>/', views.edit_user, name='edit_user'),
    path('administrator/update-user/', views.update_user, name='update_user'),
]